          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={1}>
              ...
              <LocalizationProvider dateAdapter={AdapterDateFns} locale={vi}>
                ...
                {formErrors.dateOfBirth && <FormHelperText error>Date of birth is required!</FormHelperText>}
                {formErrors.dateOfBirth && <FormHelperText error>User must be at least 18 years old!</FormHelperText>}
              </Grid>
              <Grid item xs={3} sx={{ display: 'flex', alignItems: 'center' }}>
                <Typography>
                  Gender
              ...
              <LocalizationProvider dateAdapter={AdapterDateFns} locale={vi}>
                ...
                {formErrors.joinedDate && <FormHelperText error>
                  {formErrors.joinedDate && user.joinedDate && user.dateOfBirth && new Date(user.joinedDate) < new Date(user.dateOfBirth) 
              ...
              <Grid item xs={7}>
                <FormControl fullWidth margin="dense" required error={formErrors.type}>
                  ...
                  {formErrors.type && <FormHelperText error>Type is required!</FormHelperText>}
                </FormControl>
              </Grid>

              <Grid item xs={3} sx={{ display: user.type === 'admin' ? 'flex' : 'none', alignItems: 'center' }}>
                <Typography>
                  Location
                  <span style={{ color: '#d32f2f', marginLeft: '4px' }}>*</span>
                </Typography>
              ...
              <Grid item xs={7} sx={{ display: user.type === 'admin' ? 'block' : 'none' }}>
                <FormControl fullWidth margin="dense" required error={formErrors.location}>
                  ...
                  {formErrors.location && <FormHelperText error>Location is required!</FormHelperText>}
                </FormControl>
              </Grid>
